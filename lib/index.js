      ...
      <div className="grudgeBin">
        <section className="sidebar">
          <header>
            ...
            <AddGrudge/>
            <GrudgesList grudges={this.state.grudges} grudgeCount={this.state.grudges.length}/>
          </header>
        </section>
...
const GrudgesList = ({ grudges, grudgeCount }) => {
  return (
...
const GrudgesListItem = ({ id, name, offense, active }) => {
  return (
